...
namespace QLVL_Binh.Controllers.Admin.Danhmuc.TrinhDoCMKT
{
    public class TrinhDoCMKTController : Controller
    {
        private readonly QLVL_BinhContext _db;

        public TrinhDoCMKTController(QLVL_BinhContext db)
        {
            _db = db;
        }
        ...
        public IActionResult Index()
        {
            ...
            return View("Views/Admin/Danhmuc/TrinhDoCMKT/Index.cshtml", model);
        }
